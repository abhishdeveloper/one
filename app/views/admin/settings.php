        ...
        <div style="display: flex; gap: 30px;">
            <div class="card" style="width: 250px; flex-shrink: 0; align-self: flex-start;">
                ...
                <ul style="list-style: none; padding: 0;">
                    ...
                    <li style="margin-bottom: 10px;"><a href="<?= URLROOT; ?>/index.php?url=admin/settings" style="display: block; padding: 10px; background: var(--primary-color); color: white; border-radius: 4px;">Site Settings</a></li>
                </ul>
            </div>
