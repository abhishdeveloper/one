...
<div id="chatWidget" style="position: fixed; bottom: 20px; right: 20px; width: 300px; z-index: 9999;">
    <!-- Chat Button -->
    <div id="chatHeader" style="background: var(--accent-primary); color: white; padding: 15px; border-radius: 8px; cursor: pointer; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    <!-- Chat Body -->
    <div id="chatBody" style="display: none; background: var(--bg-surface); border: 1px solid var(--border-color); border-radius: 0 0 8px 8px; height: 350px; flex-direction: column;">
        ...
        <div style="padding: 10px; border-top: 1px solid var(--border-color); background: var(--bg-main);">
            <form id="chatForm" style="display: flex; gap: 5px;">
                <input type="text" id="chatInput" style="flex-grow: 1; padding: 8px; border: 1px solid var(--border-color); border-radius: 4px; background: var(--bg-surface); color: white;" placeholder="Type a message..." required autocomplete="off">
