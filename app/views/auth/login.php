...
<section class="section bg-light" style="min-height: 80vh; display: flex; align-items: center;">
    <div class="container" style="max-width: 500px; margin: 0 auto;">
        <div class="card">
            <h2 class="text-center" style="margin-bottom: 20px;">Login to Your Account</h2>

            <?php if(isset($_SESSION['flash_message'])): ?>
                <div style="background-color: #059669; color: white; padding: 10px; border-radius: 4px; margin-bottom: 20px; text-align: center;">
